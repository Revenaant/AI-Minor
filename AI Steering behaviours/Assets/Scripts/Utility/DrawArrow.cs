...
public static class DrawArrow
{
    ...
    public static void DrawDebugLine(Vector3 start, Vector3 end, Color color, float arrowHeadLength = 0.25f, float arrowHeadAngle = 20.0f, float arrowPosition = 0.5f)
    {
        Vector3 direction = end - start;
        Debug.DrawLine(start, end, color);
        DrawArrowEnd(false, start, direction, color, arrowHeadLength, arrowHeadAngle, arrowPosition);
    }
